...
function Dataex() {
  ...
  const idstyle = { width: "2%", height: "30px" };
  const prostyle = { width: "7%", height: "30px" };
  const picstyle = { width: "auto", height: "40px" };
  const fnstyle = { width: "7%", height: "30px" };
  const lnstyle = { width: "6%", height: "30px" };
  const genstyle = { width: "4%", height: "30px" };
  const emastyle = { width: "15%", height: "30px" };
  const usestyle = { width: "8%", height: "30px" };
  const domstyle = { width: "9%", height: "30px" };
  const ipstyle = { width: "9%", height: "30px" };
  const unistyle = {
    width: "27%",
    height: "20px",
    border: "1px",
    ...
    return data.map((val) => {
      return (
        <div className="d-flex" style={rowstyle}>
          <div className="text-light p-2" style={idstyle}>
            {val.id}
          </div>
          <div className="text-light  p-0" style={prostyle}>
  ...
  return (
    <div className="d-flex flex-column my-2 mx-3 border rounded border-light" style={datatable}>
      <div className=" border rounded border-light d-flex" id="toprow" style={rowstyle}>
